...
<table border="1" align="center" id="grad1">
    ...
    <tr>
        <td>性別</td>
        <td>
        <input  type="radio" name="cSex" value="M" <?php if ($row_result["cSex"] == "M") {print"checked";
}
?>>男
        <input  type="radio" name="cSex" value="F" <?php if ($row_result["cSex"] == "F") {print"checked";
}
?>>女
        </td>
    </tr>
    ...
    <tr>
        <td>電郵</td>
        <td><input type="text" name="eEmail" size="50" value="<?php print$row_result["cEmail"];?>"></td>
    </tr>
    <tr>
        <td>電話</td>
